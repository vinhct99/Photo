...
public class Contact {
    ...
    public String getIcon_face() throws Exception {
        return DBContext.getInstance().getImagePath() +icon_face;
    }
    ...
    public String getIcon_twitter() throws Exception {
        return DBContext.getInstance().getImagePath() + icon_twitter;
    }
    ...
    public String getIcon_google() throws Exception {
        return DBContext.getInstance().getImagePath() +  icon_google;
    }
    ...
    public String getImage_main() throws Exception {
        return DBContext.getInstance().getImagePath() + image_main;
    }
